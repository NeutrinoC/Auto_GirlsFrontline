...
# 更新公告
8.14第二次更新：又一个改动，也不知道该怎么描述，反正就是这次版本更新后，在人形选择界面会同时显示当前人形，然后你不同轮次应该选择不同的人形，总之就是之前0-2和8-1n不行了就是。当然，作为新时代的新青年，这可难不倒我，在战前准备阶段额外添加了一轮更换打手的操作，如此一来排序第一的人形一定会被放在第一队，然后后面逐轮轮换就是了。我自己各试了5轮，应该没有问题，今晚上也趁着经验up挂一晚上8-1n测试一下
8.14第三次更新：刚才上线又一个更新包，然后挂8-1n的时候发现受损排序的默认顺序又改成血量低的在前面了，我白天改的又改回去了，合着这次版本更新后的顺序变化也是个bug？真是为难云母0.5个程序员了...
