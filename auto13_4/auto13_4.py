...
#机场位置点
AIRPORT_1_CLICK_BOX = [0.697,0.43,0.717,0.455]#右机场
AIRPORT_2_CLICK_BOX = [0.435,0.48,0.455,0.50]#左机场
...
PLAN_POINT1_CLICK_BOX = [0.66,0.48,0.675,0.5]#点击计划点1 
PLAN_POINT2_CLICK_BOX = [0.695,0.575,0.715,0.60]#点击计划点2
PLAN_POINT3_CLICK_BOX = [0.695,0.53,0.715,0.55]#点击计划点3
